...
import numpy as np
try:
    # Works when se3dif is installed as a top-level package.
    from se3dif import models
    from se3dif.utils import get_pretrained_models_src, load_experiment_specifications
except ModuleNotFoundError:
    # Works when using this repo without `pip install -e third_party/grasp_diffusion`.
    from .. import models
    from ..utils import get_pretrained_models_src, load_experiment_specifications
